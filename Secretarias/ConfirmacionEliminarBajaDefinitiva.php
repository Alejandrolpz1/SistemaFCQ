...
<body>
    <nav>
        ...
        <h1 id="tituloLaboratorio"><img src="../iconos/logoFCQ.png" width="80">Eliminar Alumnos de baja Definitiva</h1>
    </nav>
    <?php
    ...
    <div class="contenedor2">
        <div class="parte3">
            <h4>¿Está seguro de eliminar permanentemente a todos los estudiantes que hayan sido dados de baja definitiva?</h4>
            ...
            <form method="get" action="ListaAlumnosBaja.php" name="">
            ...
            <form method="post" action="EliminarGruposAlumnos.php">
                <input class="controls" type="hidden" id="estatus" name="estatus" value="Baja Definitiva">
                <input class="controls" type="hidden" id="carrera" name="carrera" value="<?php echo $carrera ?> ">
