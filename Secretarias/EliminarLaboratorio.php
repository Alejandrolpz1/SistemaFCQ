...
<body>
    <nav>
        ...
        <h1 id="tituloLaboratorio"><img src="../iconos/logoFCQ.png" width="80">Eliminando Laboratorio</h1>
    </nav>
    ...
    <div class="loader">
        ...
        <?php 
            ...
            $registros = eliminarLaboratorio($idLaboratorio);       
            //$registros = eliminarAlumnosWhereMatricula($idLaboratorio);          
        ?>
    </div>
</body>
